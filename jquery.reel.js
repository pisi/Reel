    ...
    return applicable.each(function(){
      var t= $(this),
          ...
          on= {
            ...
            start: function(e){
              var hotspot= set.hotspot ? set.hotspot : t,
            ...
            frameChange: function(e, frame){
              ...
              if (!set.stitched){
                var major= Math.floor(frame / set.footage),
                ...
                var step= set.stitched / frames,
                    x= frame * step,
                    y= 0,
                    shift= x + 'px 0' + y + 'px';
              }
              var indicator= ((space.x - set.indicator) / (frames - 1) * (frame - 1)) + 'px';

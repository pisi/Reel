...
Reel is very well tested. To date we have **1192 tests in 317 tasks and 10 modules**.
Between releases (1.1.4 and 1.2), the unit test coverage has been **increased by 470%**
